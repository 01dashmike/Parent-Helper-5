...
export async function saveStep3Class(
  prevState: OnboardingFormState | null,
  formData: FormData
): Promise<OnboardingFormState> {
  return saveStep3ClassTemplate(prevState, formData);
}
...
export async function acknowledgePreview(
  ...
  return saveStep5Preview(prevState, formData);
}

export async function completeOnboardingAndPublish(
  prevState: OnboardingFormState | null,
  formData: FormData
): Promise<OnboardingFormState> {
  return saveStep6Publish(prevState, formData);
}
